...
extern TraceEvent _TRACE_AXP209_RX_EVENT;
extern TraceEvent _TRACE_AXP209_SELECT_EVENT;
extern TraceEvent _TRACE_AXP209_TX_EVENT;
...
extern uint16_t _TRACE_AXP209_RX_DSTATE;
extern uint16_t _TRACE_AXP209_SELECT_DSTATE;
extern uint16_t _TRACE_AXP209_TX_DSTATE;
...
#define TRACE_AXP209_RX_ENABLED 1
#define TRACE_AXP209_SELECT_ENABLED 1
#define TRACE_AXP209_TX_ENABLED 1
...
#define TRACE_AXP209_RX_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_AXP209_RX) || \
    false)

static inline void _nocheck__trace_axp209_rx(uint8_t reg, uint8_t data)
{
    if (trace_event_get_state(TRACE_AXP209_RX) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 27 "../hw/misc/trace-events"
            qemu_log("%d@%zu.%06zu:axp209_rx " "Read reg 0x%" PRIx8 " : 0x%" PRIx8 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , reg, data);
...
#line 27 "../hw/misc/trace-events"
            qemu_log("axp209_rx " "Read reg 0x%" PRIx8 " : 0x%" PRIx8 "\n", reg, data);
#line 1073 "trace/trace-hw_misc.h"
        }
    }
}

static inline void trace_axp209_rx(uint8_t reg, uint8_t data)
{
    if (true) {
        _nocheck__trace_axp209_rx(reg, data);
    }
}

#define TRACE_AXP209_SELECT_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_AXP209_SELECT) || \
    false)

static inline void _nocheck__trace_axp209_select(uint8_t reg)
{
    if (trace_event_get_state(TRACE_AXP209_SELECT) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 28 "../hw/misc/trace-events"
            qemu_log("%d@%zu.%06zu:axp209_select " "Accessing reg 0x%" PRIx8 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , reg);
...
#line 28 "../hw/misc/trace-events"
            qemu_log("axp209_select " "Accessing reg 0x%" PRIx8 "\n", reg);
#line 1104 "trace/trace-hw_misc.h"
        }
    }
}

static inline void trace_axp209_select(uint8_t reg)
{
    if (true) {
        _nocheck__trace_axp209_select(reg);
    }
}

#define TRACE_AXP209_TX_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_AXP209_TX) || \
    false)

static inline void _nocheck__trace_axp209_tx(uint8_t reg, uint8_t data)
{
    if (trace_event_get_state(TRACE_AXP209_TX) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 29 "../hw/misc/trace-events"
            qemu_log("%d@%zu.%06zu:axp209_tx " "Write reg 0x%" PRIx8 " : 0x%" PRIx8 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , reg, data);
...
#line 29 "../hw/misc/trace-events"
            qemu_log("axp209_tx " "Write reg 0x%" PRIx8 " : 0x%" PRIx8 "\n", reg, data);
#line 1135 "trace/trace-hw_misc.h"
        }
    }
}

static inline void trace_axp209_tx(uint8_t reg, uint8_t data)
{
    if (true) {
        _nocheck__trace_axp209_tx(reg, data);
    }
}
