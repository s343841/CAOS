...
uint16_t _TRACE_QMP_ENTER_QUERY_MIGRATIONTHREADS_DSTATE;
uint16_t _TRACE_QMP_EXIT_QUERY_MIGRATIONTHREADS_DSTATE;
...
TraceEvent _TRACE_QMP_ENTER_QUERY_MIGRATIONTHREADS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "qmp_enter_query_migrationthreads",
    .sstate = TRACE_QMP_ENTER_QUERY_MIGRATIONTHREADS_ENABLED,
    .dstate = &_TRACE_QMP_ENTER_QUERY_MIGRATIONTHREADS_DSTATE 
};
TraceEvent _TRACE_QMP_EXIT_QUERY_MIGRATIONTHREADS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "qmp_exit_query_migrationthreads",
    .sstate = TRACE_QMP_EXIT_QUERY_MIGRATIONTHREADS_ENABLED,
    .dstate = &_TRACE_QMP_EXIT_QUERY_MIGRATIONTHREADS_DSTATE 
};
...
TraceEvent *qapi_commands_migration_trace_events_trace_events[] = {
    ...
    &_TRACE_QMP_ENTER_QUERY_MIGRATIONTHREADS_EVENT,
    &_TRACE_QMP_EXIT_QUERY_MIGRATIONTHREADS_EVENT,
