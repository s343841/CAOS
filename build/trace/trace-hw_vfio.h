...
static inline void _nocheck__trace_vfio_device_dirty_tracking_start(int nr_ranges, uint64_t min32, uint64_t max32, uint64_t min64, uint64_t max64)
{
...
#line 107 "../hw/vfio/trace-events"
            qemu_log("%d@%zu.%06zu:vfio_device_dirty_tracking_start " "nr_ranges %d 32:[0x%"PRIx64" - 0x%"PRIx64"], 64:[0x%"PRIx64" - 0x%"PRIx64"]" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , nr_ranges, min32, max32, min64, max64);
#line 3417 "trace/trace-hw_vfio.h"
        } else {
#line 107 "../hw/vfio/trace-events"
            qemu_log("vfio_device_dirty_tracking_start " "nr_ranges %d 32:[0x%"PRIx64" - 0x%"PRIx64"], 64:[0x%"PRIx64" - 0x%"PRIx64"]" "\n", nr_ranges, min32, max32, min64, max64);
#line 3421 "trace/trace-hw_vfio.h"
        }
    }
}

static inline void trace_vfio_device_dirty_tracking_start(int nr_ranges, uint64_t min32, uint64_t max32, uint64_t min64, uint64_t max64)
{
    if (true) {
        _nocheck__trace_vfio_device_dirty_tracking_start(nr_ranges, min32, max32, min64, max64);
    }
}
...
static inline void _nocheck__trace_vfio_migration_probe(const char * name)
{
...
#line 158 "../hw/vfio/trace-events"
            qemu_log("%d@%zu.%06zu:vfio_migration_probe " " (%s)" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , name);
...
#line 158 "../hw/vfio/trace-events"
            qemu_log("vfio_migration_probe " " (%s)" "\n", name);
#line 4754 "trace/trace-hw_vfio.h"
        }
    }
}

static inline void trace_vfio_migration_probe(const char * name)
{
    if (true) {
        _nocheck__trace_vfio_migration_probe(name);
    }
}
...
static inline void _nocheck__trace_vfio_migration_set_state(const char * name, const char * state)
{
...
#line 159 "../hw/vfio/trace-events"
            qemu_log("%d@%zu.%06zu:vfio_migration_set_state " " (%s) state %s" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , name, state);
...
#line 159 "../hw/vfio/trace-events"
            qemu_log("vfio_migration_set_state " " (%s) state %s" "\n", name, state);
#line 4785 "trace/trace-hw_vfio.h"
        }
    }
}

static inline void trace_vfio_migration_set_state(const char * name, const char * state)
{
    if (true) {
...
static inline void _nocheck__trace_vfio_state_pending_exact(const char * name, uint64_t precopy, uint64_t postcopy, uint64_t stopcopy_size)
{
...
#line 166 "../hw/vfio/trace-events"
            qemu_log("%d@%zu.%06zu:vfio_state_pending_exact " " (%s) precopy 0x%"PRIx64" postcopy 0x%"PRIx64" stopcopy size 0x%"PRIx64 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , name, precopy, postcopy, stopcopy_size);
#line 4998 "trace/trace-hw_vfio.h"
        } else {
#line 166 "../hw/vfio/trace-events"
            qemu_log("vfio_state_pending_exact " " (%s) precopy 0x%"PRIx64" postcopy 0x%"PRIx64" stopcopy size 0x%"PRIx64 "\n", name, precopy, postcopy, stopcopy_size);
#line 5002 "trace/trace-hw_vfio.h"
        }
    }
}

static inline void trace_vfio_state_pending_exact(const char * name, uint64_t precopy, uint64_t postcopy, uint64_t stopcopy_size)
{
    if (true) {
        _nocheck__trace_vfio_state_pending_exact(name, precopy, postcopy, stopcopy_size);
    }
}
