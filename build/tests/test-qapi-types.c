...
const QEnumLookup TestUnionEnum_lookup = {
    .array = (const char *const[]) {
        [TEST_UNION_ENUM_VALUE_A] = "value-a",
        [TEST_UNION_ENUM_VALUE_B] = "value-b",
    },
    .size = TEST_UNION_ENUM__MAX
};

const QEnumLookup TestUnionEnumA_lookup = {
    .array = (const char *const[]) {
        [TEST_UNION_ENUMA_VALUE_A1] = "value-a1",
        [TEST_UNION_ENUMA_VALUE_A2] = "value-a2",
    },
    .size = TEST_UNION_ENUMA__MAX
};
...
void qapi_free_TestUnionTypeA1(TestUnionTypeA1 *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_TestUnionTypeA1(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_TestUnionTypeA2(TestUnionTypeA2 *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_TestUnionTypeA2(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_TestUnionTypeA(TestUnionTypeA *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_TestUnionTypeA(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_TestUnionTypeB(TestUnionTypeB *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_TestUnionTypeB(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_TestUnionInUnion(TestUnionInUnion *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_TestUnionInUnion(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_AltListInt(AltListInt *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_AltListInt(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_ArrayStruct(ArrayStruct *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_ArrayStruct(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free___org_qemu_x_UnionList(__org_qemu_x_UnionList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type___org_qemu_x_UnionList(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free___org_qemu_x_Union(__org_qemu_x_Union *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type___org_qemu_x_Union(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_CondFeatureStruct4(CondFeatureStruct4 *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_CondFeatureStruct4(v, NULL, &obj, NULL);
    visit_free(v);
}

const QEnumLookup FeatureEnum1_lookup = {
    .array = (const char *const[]) {
        [FEATURE_ENUM1_EINS] = "eins",
        [FEATURE_ENUM1_ZWEI] = "zwei",
        [FEATURE_ENUM1_DREI] = "drei",
    },
    .special_features = (const unsigned char[FEATURE_ENUM1__MAX]) {
        [FEATURE_ENUM1_DREI] = 1u << QAPI_DEPRECATED,
    },
    .size = FEATURE_ENUM1__MAX
};
...
void qapi_free_FeatureUnion1(FeatureUnion1 *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_FeatureUnion1(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_FeatureAlternate1(FeatureAlternate1 *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_FeatureAlternate1(v, NULL, &obj, NULL);
    visit_free(v);
}
