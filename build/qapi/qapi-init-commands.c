...
void qmp_init_marshal(QmpCommandList *cmds)
{
    ...
    qmp_register_command(cmds, "block_set_io_throttle",
                         qmp_marshal_block_set_io_throttle, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-latency-histogram-set",
                         qmp_marshal_block_latency_histogram_set, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "query-block",
                         qmp_marshal_query_block, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "query-blockstats",
                         qmp_marshal_query_blockstats, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "query-block-jobs",
                         qmp_marshal_query_block_jobs, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block_resize",
                         qmp_marshal_block_resize, QCO_ALLOW_PRECONFIG | QCO_COROUTINE, 0);
    qmp_register_command(cmds, "blockdev-snapshot-sync",
                         qmp_marshal_blockdev_snapshot_sync, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "blockdev-snapshot",
                         qmp_marshal_blockdev_snapshot, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "change-backing-file",
                         qmp_marshal_change_backing_file, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-commit",
                         qmp_marshal_block_commit, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "drive-backup",
                         qmp_marshal_drive_backup, QCO_ALLOW_PRECONFIG, 1u << QAPI_DEPRECATED);
    qmp_register_command(cmds, "blockdev-backup",
                         qmp_marshal_blockdev_backup, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "query-named-block-nodes",
                         qmp_marshal_query_named_block_nodes, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "x-debug-query-block-graph",
                         qmp_marshal_x_debug_query_block_graph, QCO_ALLOW_PRECONFIG, 1u << QAPI_UNSTABLE);
    qmp_register_command(cmds, "drive-mirror",
                         qmp_marshal_drive_mirror, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-dirty-bitmap-add",
                         qmp_marshal_block_dirty_bitmap_add, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-dirty-bitmap-remove",
                         qmp_marshal_block_dirty_bitmap_remove, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-dirty-bitmap-clear",
                         qmp_marshal_block_dirty_bitmap_clear, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-dirty-bitmap-enable",
                         qmp_marshal_block_dirty_bitmap_enable, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-dirty-bitmap-disable",
                         qmp_marshal_block_dirty_bitmap_disable, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-dirty-bitmap-merge",
                         qmp_marshal_block_dirty_bitmap_merge, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "x-debug-block-dirty-bitmap-sha256",
                         qmp_marshal_x_debug_block_dirty_bitmap_sha256, QCO_ALLOW_PRECONFIG, 1u << QAPI_UNSTABLE);
    qmp_register_command(cmds, "blockdev-mirror",
                         qmp_marshal_blockdev_mirror, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-stream",
                         qmp_marshal_block_stream, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-job-set-speed",
                         qmp_marshal_block_job_set_speed, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-job-cancel",
                         qmp_marshal_block_job_cancel, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-job-pause",
                         qmp_marshal_block_job_pause, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-job-resume",
                         qmp_marshal_block_job_resume, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-job-complete",
                         qmp_marshal_block_job_complete, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-job-dismiss",
                         qmp_marshal_block_job_dismiss, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-job-finalize",
                         qmp_marshal_block_job_finalize, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "blockdev-add",
                         qmp_marshal_blockdev_add, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "blockdev-reopen",
                         qmp_marshal_blockdev_reopen, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "blockdev-del",
                         qmp_marshal_blockdev_del, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "blockdev-create",
                         qmp_marshal_blockdev_create, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "x-blockdev-amend",
                         qmp_marshal_x_blockdev_amend, QCO_ALLOW_PRECONFIG, 1u << QAPI_UNSTABLE);
    qmp_register_command(cmds, "block-set-write-threshold",
                         qmp_marshal_block_set_write_threshold, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "x-blockdev-change",
                         qmp_marshal_x_blockdev_change, QCO_ALLOW_PRECONFIG, 1u << QAPI_UNSTABLE);
    qmp_register_command(cmds, "x-blockdev-set-iothread",
                         qmp_marshal_x_blockdev_set_iothread, QCO_ALLOW_PRECONFIG, 1u << QAPI_UNSTABLE);
    qmp_register_command(cmds, "blockdev-snapshot-internal-sync",
                         qmp_marshal_blockdev_snapshot_internal_sync, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "blockdev-snapshot-delete-internal-sync",
                         qmp_marshal_blockdev_snapshot_delete_internal_sync, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "nbd-server-start",
                         qmp_marshal_nbd_server_start, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "nbd-server-add",
                         qmp_marshal_nbd_server_add, QCO_ALLOW_PRECONFIG, 1u << QAPI_DEPRECATED);
    qmp_register_command(cmds, "nbd-server-remove",
                         qmp_marshal_nbd_server_remove, QCO_ALLOW_PRECONFIG, 1u << QAPI_DEPRECATED);
    qmp_register_command(cmds, "nbd-server-stop",
                         qmp_marshal_nbd_server_stop, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-export-add",
                         qmp_marshal_block_export_add, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "block-export-del",
                         qmp_marshal_block_export_del, QCO_ALLOW_PRECONFIG, 0);
    qmp_register_command(cmds, "query-block-exports",
                         qmp_marshal_query_block_exports, QCO_ALLOW_PRECONFIG, 0);
    ...
    qmp_register_command(cmds, "display-update",
                         qmp_marshal_display_update, 0, 0);
    ...
    qmp_register_command(cmds, "set-vcpu-dirty-limit",
                         qmp_marshal_set_vcpu_dirty_limit, 0, 0);
    qmp_register_command(cmds, "cancel-vcpu-dirty-limit",
                         qmp_marshal_cancel_vcpu_dirty_limit, 0, 0);
    qmp_register_command(cmds, "query-vcpu-dirty-limit",
                         qmp_marshal_query_vcpu_dirty_limit, 0, 0);
    qmp_register_command(cmds, "query-migrationthreads",
                         qmp_marshal_query_migrationthreads, 0, 0);
    ...
    qmp_register_command(cmds, "dumpdtb",
                         qmp_marshal_dumpdtb, 0, 0);
    ...
    qmp_register_command(cmds, "get-win32-socket",
                         qmp_marshal_get_win32_socket, 0, 0);
    ...
    qmp_register_command(cmds, "query-stats",
                         qmp_marshal_query_stats, 0, 0);
    qmp_register_command(cmds, "query-stats-schemas",
                         qmp_marshal_query_stats_schemas, 0, 0);
    qmp_register_command(cmds, "x-query-virtio",
                         qmp_marshal_x_query_virtio, 0, 1u << QAPI_UNSTABLE);
    qmp_register_command(cmds, "x-query-virtio-status",
                         qmp_marshal_x_query_virtio_status, 0, 1u << QAPI_UNSTABLE);
    qmp_register_command(cmds, "x-query-virtio-queue-status",
                         qmp_marshal_x_query_virtio_queue_status, 0, 1u << QAPI_UNSTABLE);
    qmp_register_command(cmds, "x-query-virtio-vhost-queue-status",
                         qmp_marshal_x_query_virtio_vhost_queue_status, 0, 1u << QAPI_UNSTABLE);
    qmp_register_command(cmds, "x-query-virtio-queue-element",
                         qmp_marshal_x_query_virtio_queue_element, 0, 1u << QAPI_UNSTABLE);
    qmp_register_command(cmds, "query-cryptodev",
                         qmp_marshal_query_cryptodev, 0, 0);
    qmp_register_command(cmds, "cxl-inject-uncorrectable-errors",
                         qmp_marshal_cxl_inject_uncorrectable_errors, 0, 0);
    qmp_register_command(cmds, "cxl-inject-correctable-error",
                         qmp_marshal_cxl_inject_correctable_error, 0, 0);
}
