...
void qmp_marshal_block_commit(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_block_commit(arg.job_id, arg.device, arg.base_node, arg.base, arg.top_node, arg.top, arg.backing_file, arg.has_speed, arg.speed, arg.has_on_error, arg.on_error, arg.filter_node_name, arg.has_auto_finalize, arg.auto_finalize, arg.has_auto_dismiss, arg.auto_dismiss, &err);
    if (err) {
...
void qmp_marshal_block_stream(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_block_stream(arg.job_id, arg.device, arg.base, arg.base_node, arg.backing_file, arg.bottom, arg.has_speed, arg.speed, arg.has_on_error, arg.on_error, arg.filter_node_name, arg.has_auto_finalize, arg.auto_finalize, arg.has_auto_dismiss, arg.auto_dismiss, &err);
    if (err) {
